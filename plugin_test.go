...
var openapiTests = []struct {
	...
	{name: "HTTP bindings", path: "examples/tests/httpbindings/", protofile: "message.proto"},
	...
	{name: "Multiple default hosts", path: "examples/tests/multihost/", protofile: "message.proto"},
	{name: "Sibling query params", path: "examples/tests/siblingqueryparams/", protofile: "message.proto"},
	{name: "Schema name collisions", path: "examples/tests/schemacollision/", protofile: "message.proto"},
