...
func main() {
	conf := generator.Configuration{
		...
		ResourceIDPattern: flags.String("resource_id_pattern", "[a-z2-7]{26}", `regex matching each variable segment of a google.api.resource pattern, used to build the "name" field pattern. Set to "" to omit the pattern`),
	}
